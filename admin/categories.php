...
if (isset($_GET['edit']) && is_numeric($_GET['edit'])) {
    ...
    if ($edit_result->num_rows > 0) {
        ...
        // Thiết lập biến JavaScript để mở modal trong trường hợp chỉnh sửa
        $page_js[] = '<script>var editMode = true;</script>';
    } else {
        // Nếu không tìm thấy danh mục cần sửa
        $error_message = "Không tìm thấy danh mục với ID: " . $edit_id;
        header('Location: categories.php?error=' . urlencode($error_message));
        exit();
    }
} else {
    // Không có tham số edit, đảm bảo rằng không có dữ liệu chỉnh sửa
    $page_js[] = '<script>var editMode = false;</script>';
}
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="GET" action="">
                    ...
                    <!-- Lọc nâng cao -->
                    <div class="collapse <?php echo ($status !== '' || $sort != 'id_desc') ? 'show' : ''; ?>"
                        id="filtersCollapse">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="status" name="status">
                                    ...
                                    <option value="1" <?php echo ($status === '1') ? 'selected' : ''; ?>>Đang hiển thị
                                    </option>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="sort" name="sort">
                                    <option value="id_desc" <?php echo ($sort == 'id_desc') ? 'selected' : ''; ?>>Mặc định
                                        (Mới nhất)</option>
                                    <option value="name_asc" <?php echo ($sort == 'name_asc') ? 'selected' : ''; ?>>Tên
                                        A-Z</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="category-name"
                                                title="<?php echo htmlspecialchars($category['ten']); ?>">
                                        ...
                                        <td>
                                            <div class="small mb-1">
                                                <span class="badge bg-primary"><?php echo $category['subcategory_count']; ?>
                                                    danh mục con</span>
                                            </div>
                                            <div class="small">
                                                <span class="badge bg-info"><?php echo $category['product_count']; ?> sản
                                                    phẩm</span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1 mb-1">
                                                <a href="categories.php?edit=<?php echo $category['id']; ?>"
                                                    class="btn btn-sm btn-primary flex-grow-1 edit-button">
                                            ...
                                            <div class="d-flex gap-1">
                                                <a href="categories.php?toggle_status=<?php echo $category['id']; ?>"
                                                    ...
                                                    <i
                                                        class="fas <?php echo $category['trang_thai'] ? 'fa-eye-slash' : 'fa-eye'; ?>"></i>
                                                    <?php echo $category['trang_thai'] ? 'Ẩn' : 'Hiện'; ?>
                                                </a>
...
<div class="modal fade" id="categoryModal" tabindex="-1" aria-labelledby="categoryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="category_save.php" method="POST" enctype="multipart/form-data" id="categoryForm">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="mb-3">
                                <label for="ten" class="form-label">Tên danh mục <span
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="danhmuc_cha" name="danhmuc_cha">
                                    ...
                                    <?php foreach ($all_categories as $id => $name): ?>
                                        <?php if ($category_to_edit && $id == $category_to_edit['id'])
                                            continue; // Không thể chọn chính nó làm cha ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="mo_ta" name="mo_ta"
                                    rows="4"><?php echo $category_to_edit ? htmlspecialchars($category_to_edit['mo_ta']) : ''; ?></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="meta_description" name="meta_description"
                                    rows="3"><?php echo $category_to_edit ? htmlspecialchars($category_to_edit['meta_description']) : ''; ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="trang_thai" name="trang_thai"
                                        value="1" <?php echo (!$category_to_edit || $category_to_edit['trang_thai'] == 1) ? 'checked' : ''; ?>>
