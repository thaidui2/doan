    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                ...
                <img src="images/logo.png" alt="<?php echo htmlspecialchars($shop_name); ?> Logo" height="40" class="d-inline-block mb-3">
            ...
            <div class="col-md-3 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="sanpham.php?loai=1" class="text-white text-decoration-none">Giày nam</a></li>
                    <li class="mb-2"><a href="sanpham.php?loai=2" class="text-white text-decoration-none">Giày nữ</a></li>
                    <li class="mb-2"><a href="khuyen-mai.php" class="text-white text-decoration-none">Khuyến mãi</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-3 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><i class="bi bi-geo-alt me-2"></i><?php echo htmlspecialchars($shop_address); ?></li>
                    <li class="mb-2"><i class="bi bi-telephone me-2"></i><?php echo htmlspecialchars($shop_phone); ?></li>
                    <li class="mb-2"><i class="bi bi-envelope me-2"></i><?php echo htmlspecialchars($shop_email); ?></li>
            ...
            <div class="col-md-3 mb-4">
                ...
                <!-- Social Media Links -->
                <div class="mt-3">
                    <a href="<?php echo htmlspecialchars($facebook_url); ?>" class="text-white me-3" target="_blank"><i class="bi bi-facebook fs-5"></i></a>
                    <a href="<?php echo htmlspecialchars($instagram_url); ?>" class="text-white me-3" target="_blank"><i class="bi bi-instagram fs-5"></i></a>
                    <a href="<?php echo htmlspecialchars($twitter_url); ?>" class="text-white me-3" target="_blank"><i class="bi bi-twitter fs-5"></i></a>
                    <a href="<?php echo htmlspecialchars($youtube_url); ?>" class="text-white" target="_blank"><i class="bi bi-youtube fs-5"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-4 pt-3 border-top">
            <div class="col-md-6 small">
                <p class="mb-0">&copy; <?php echo date('Y'); ?> <?php echo htmlspecialchars($shop_name); ?>. Tất cả các quyền được bảo lưu.</p>
            </div>
