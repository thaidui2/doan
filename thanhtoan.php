...
<!-- Add data attribute to body tag to pass login status to JavaScript -->
<body data-user-logged-in="<?php echo $is_logged_in ? 'true' : 'false'; ?>">
<?php 
...
<!-- Hidden form fields to pass PHP data to JavaScript -->
<input type="hidden" id="subtotal-value" value="<?php echo $total_amount; ?>">
<input type="hidden" id="shipping-fee-value" value="30000">
<input type="hidden" id="checkout-items-data" value="<?php echo htmlspecialchars(json_encode($checkout_items)); ?>">
